      ...
      <View className="flex-1 justify-between px-6 pb-4 pt-2">
        <View>
          ...
          <View
            ...
            style={{ height: 370 }}
          >
            <View className="absolute left-[10%] top-[6%] rounded-2xl rounded-bl-md bg-blue-tint px-4 py-2.5">
              <Text className="text-body-md font-poppins-medium text-text-primary">Hello!</Text>
            </View>
            <View className="absolute right-[10%] top-0 rounded-2xl rounded-br-md bg-purple-tint px-4 py-2.5">
              <Text className="text-body-md font-poppins-medium text-purple">¡Hola!</Text>
            </View>
            <View className="absolute right-[4%] top-[22%] rounded-2xl rounded-br-md bg-peach px-4 py-2.5">
